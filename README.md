...
1. Fork the repo (not recommend directly using my original page due to security reason);
...
5. The trails record rely on GPX files (GPS data format). One way to obtain it is to export apple watch health data (you can easily find your workout routes in GPX format in the exported zip).
