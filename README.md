...
2. Create your own private data managing repo (say "my_data") on your own github (note this page can run on my github while you own your own data repo), and then enable a fine-grained token to access this my_data repo;
...
5. Because the restaurant is open and I as well welcome you to come to use it even if you're not a customer nor currently having your own table/hotpot machine in the restaurant (=your own github account)
...
8. You can if you want to pass your meat ball from one pair of chopsticks (=your first device) to another pair (=your second device), but there're cases when you need to head out and come back later but you don't want to take your meat ball with you all the time (you can if you want!), or it could be that you have too many meatballs and your chopsticks cannot hold them (=you generate too much data and your device cannot store them)
9. Now I tell you, I have a food box (=the "github data repository" I created) for you to put your tasty meat balls in (=to store your processed data in). And because there's some magic on the food box, only I, you and other granted friends can use it (the grant here means the token I generate and give you to sync your data, and *magic* food box = *private* github data repository)
10. Now you are happy and you can transfer your meat balls (=your processed/organized data) from your chopsticks (=your own device and browser) to the magic food box (=private data repository). Whenever you want, you can come back and use any pair of your chopsticks to take those food balls out (=using any device of yours to reaccess your trail journal)
11. Instead of letting other friends of mine to use the same magic food box with you, I can also grab another magic food box for them (=create another private github data repo for them) so that you both dont need to worry the other person can access the private meat balls
...
14. In some cases you might think "I don't want other magic bowl granted users to also use this ball!" so you ask me and I encourage you to put a lock (=data encryption) on the magic food box. Then even I cannot open up the box. On the other hand if you forget your key to the lock (=foret the passphrase when you establish the encryption) you will never be able to take out and appreciate your tasty meat balls! I wish but I cannot do that for you either!
